...
const slice = createSlice({
  ...
  reducers: {
    changeOrderTasks: (state, action: PayloadAction<{ tasks: TaskType[]; todolistId: string }>) => {
    ...
    transferingTask: (
      ...
      state[action.payload.todolistId] = action.payload.targetTasks
      state[action.payload.currentTodolistId] = action.payload.startTasks
    },
  },
