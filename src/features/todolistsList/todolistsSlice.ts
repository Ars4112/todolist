...
const slice = createSlice({
  ...
  reducers: {
    ...
    changeOrderTodolists: (state, action: PayloadAction<{ todolist: TodolistDomainType[] }>) => {
...
// const changeOrderTodolists = createAppAsyncThunk<{ todolists: TodolistType[] }, void>(
//   `${slice.name}/changeOrderTodolists`,
//   (_, thunkAPI) => {
